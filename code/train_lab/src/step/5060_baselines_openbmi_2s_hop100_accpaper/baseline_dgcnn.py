"""DGCNN 2s/hop100 Acc_paper：bandpower；Val Acc_paper + batch balance。"""
...
if __name__ == "__main__":
    run_baseline_main(
        ...
        input_kind="feat",
        structure_note="DGCNN(k=2, layers=[128]) + 2s bandpower",
        prepare_X=raw_to_bandpower,
        extra_meta={"dgcnn": {"backbone": "DGCNN", "k": 2}, "accpaper": True},
    )
