"""DGCNN fixed2s 离线：2s 窗 μ/β bandpower；Val BalAcc + batch balance。"""
...
if __name__ == "__main__":
    run_baseline_main(
        ...
        input_kind="feat",
        structure_note="DGCNN(k=2, layers=[128]) + 2s μ/β log bandpower (N,8,2)",
        prepare_X=raw_to_bandpower,
        extra_meta={"dgcnn": {"backbone": "DGCNN", "k": 2}},
    )
