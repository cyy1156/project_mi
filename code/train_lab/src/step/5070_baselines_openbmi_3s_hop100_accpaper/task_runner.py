...
def run_baseline_main(
    *,
    ...
    p = argparse.ArgumentParser(
        description=f"{model_name} 3s/hop100 Acc_paper 重训（OpenBMI；实验21；balbatch）"
    )
    p.add_argument(
        "--data",
    ...
    append_md(
        ...
        "\n".join(
            [
                ...
                f"- 训练设备：**NVIDIA GeForce RTX 5070 Laptop**（正式结果以本机 Fast 为准）",
    ...
    meta = {
        ...
        "train_device": "NVIDIA GeForce RTX 5070 Laptop",
