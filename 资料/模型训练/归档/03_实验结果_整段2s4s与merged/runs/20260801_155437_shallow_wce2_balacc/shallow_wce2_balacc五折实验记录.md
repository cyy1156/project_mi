# 被试独立五折实验记录（20260801_155437 / shallow_wce2_balacc）

- 开始：`2026-08-01T15:54:37`
- device：`cuda`
- data：`D:\cyy\MI\code\preprocess_lab\out\merged_2s`（prefix=`merged`）
- model：`shallow_wce2_balacc`（单脚本；无 registry）
- Task 目标：加权CE w0=2.0, w1=1.0, mode=invfreq；早停=Balanced Acc
...
- 权重：`D:\cyy\MI\code\train_lab\out\baseline\shallow_wce2_balacc\merged_2s\run_20260801_155437`
