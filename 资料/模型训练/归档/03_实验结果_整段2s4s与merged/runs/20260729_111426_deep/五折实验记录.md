# 被试独立五折实验记录（20260729_111426 / deep）

- 开始：`2026-07-29T11:14:26`
- device：`cuda`
...
- 权重：`D:\cyy\MI\code\train_lab\out\baseline\deep\merged_2s\run_20260729_111426`

---
## 最终结论

### Task（静息/任务）
- Val F1：`0.3555 ± 0.3668`
- Test F1：`0.3795 ± 0.3636`
- Test Acc：`0.4685 ± 0.1945`

### Three（空闲/左/右，独立初始化）
- Val F1-macro：`0.3539 ± 0.0901`
- Test F1-macro：`0.3284 ± 0.0718`
- Test Acc：`0.3602 ± 0.0544`
