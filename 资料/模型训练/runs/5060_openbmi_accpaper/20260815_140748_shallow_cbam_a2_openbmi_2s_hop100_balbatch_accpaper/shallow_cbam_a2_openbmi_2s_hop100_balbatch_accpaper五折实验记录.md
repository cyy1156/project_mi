# 被试独立五折实验记录（20260815_140748 / shallow_cbam_a2_openbmi_2s_hop100_balbatch_accpaper）

- 开始：`2026-08-15T14:07:48`
...
### Task
- Val Acc_paper：`0.7070 ± 0.0000`
- Test Acc_paper：`0.7194 ± 0.0000`
- Test BalAcc_maj：`0.6952 ± 0.0000`
- Test 窗级 BalAcc（附报）：`0.6648 ± 0.0000`
...
**Test 窗级（附报）**
- BalAcc：`0.6648` | F1：`0.7578` | Acc：`0.6876`

### Three
- Val Acc_paper：`0.5430 ± 0.0000`
- Test Acc_paper：`0.5342 ± 0.0000`
- Test BalAcc_maj：`0.5555 ± 0.0000`
- Test 窗级 BalAcc（附报）：`0.5246 ± 0.0000`
...
- BalAcc_maj：`0.5555`
- F1-macro（众数）：`0.5555`
- Rec idle/left/right：`0.5664` / `0.5418` / `0.5582`
- n_trials：`3300`
