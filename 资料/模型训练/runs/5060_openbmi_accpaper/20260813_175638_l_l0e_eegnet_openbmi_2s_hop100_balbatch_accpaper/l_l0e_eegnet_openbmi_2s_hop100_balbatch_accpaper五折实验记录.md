# 被试独立五折实验记录（20260813_175638 / l_l0e_eegnet_openbmi_2s_hop100_balbatch_accpaper）

- 开始：`2026-08-13T17:56:38`
...
- 权重：`D:\cyy\MI\code\train_lab\out\5060_ciacnet_mi_accpaper\l_l0e_eegnet_openbmi_2s_hop100_balbatch_accpaper\openbmi_2s_hop100\run_20260813_175638`
...
### Task
- Val Acc_paper：`0.6033 ± 0.0000`
- Test Acc_paper：`0.6030 ± 0.0000`
- Test BalAcc_maj：`0.6016 ± 0.0000`
- Test 窗级 BalAcc（附报）：`0.5843 ± 0.0000`
...
**Test 窗级（附报）**
- BalAcc：`0.5843` | F1：`0.6594` | Acc：`0.5886`

### Three
- Val Acc_paper：`0.4507 ± 0.0000`
- Test Acc_paper：`0.4503 ± 0.0000`
- Test BalAcc_maj：`0.4652 ± 0.0000`
- Test 窗级 BalAcc（附报）：`0.4549 ± 0.0000`
...
- BalAcc_maj：`0.4652`
- F1-macro（众数）：`0.4477`
- Rec idle/left/right：`0.4973` / `0.6600` / `0.2382`
- n_trials：`3300`

**Test 窗级（附报）**
- BalAcc：`0.4549` | F1m：`0.4420`
