# 被试独立五折实验记录（20260815_020815 / shallow_s0_openbmi_2s_hop100_balbatch_accpaper）

- 开始：`2026-08-15T02:08:15`
...
- model：`shallow_s0` | S0 原版 ShallowFBCSPNet · Acc_paper
- Train：窗 CE + **batch balance**；Val/Test：整被试块 + trial 聚合 Acc_paper
- 权重：`D:\cyy\MI\code\train_lab\out\5060_shallow_se_eca_accpaper\shallow_s0_openbmi_2s_hop100_balbatch_accpaper\openbmi_2s_hop100\run_20260815_020815`
...
### Task
- Val Acc_paper：`0.6829 ± 0.0364`
- Test Acc_paper：`0.6969 ± 0.0350`
- Test BalAcc_maj：`0.6766 ± 0.0186`
- Test 窗级 BalAcc（附报）：`0.6518 ± 0.0151`
...
**Test 窗级（附报）**
- BalAcc：`0.6437` | F1：`0.7209` | Acc：`0.6531`

### Three
- Val Acc_paper：`0.5226 ± 0.0315`
- Test Acc_paper：`0.5401 ± 0.0257`
- Test BalAcc_maj：`0.5581 ± 0.0257`
- Test 窗级 BalAcc（附报）：`0.5299 ± 0.0221`
