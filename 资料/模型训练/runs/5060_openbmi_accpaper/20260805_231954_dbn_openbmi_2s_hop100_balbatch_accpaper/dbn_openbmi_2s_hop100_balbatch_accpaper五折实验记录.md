# 被试独立五折实验记录（20260805_231954 / dbn_openbmi_2s_hop100_balbatch_accpaper）

- 开始：`2026-08-05T23:19:54`
- device：`cuda`
...
- 权重：`D:\cyy\MI\code\train_lab\out\5060_baseline_openbmi_2s_hop100_accpaper\dbn_openbmi_2s_hop100_balbatch_accpaper\openbmi_2s_hop100\run_20260805_231954`
...
- Test BalAcc_maj：`0.5437 ± 0.0121`
- Test 窗级 BalAcc（附报）：`0.5411 ± 0.0112`
...
**Test 窗级（附报）**
- BalAcc：`0.5349` | F1：`0.7690` | Acc：`0.6489`

#### Fold 1

- stopped_epoch：`25` | best_epoch：`5`
- Val Acc_paper（早停）：`0.6419`
- Val BalAcc_maj（附报）：`0.5617`
...
**Test 窗级（附报）**
- BalAcc：`0.5517` | F1：`0.7635` | Acc：`0.6502`
...
**Test 窗级（附报）**
- BalAcc：`0.5417` | F1：`0.6001` | Acc：`0.5355`
...
**Test 窗级（附报）**
- BalAcc：`0.5540` | F1：`0.7461` | Acc：`0.6364`
...
### Three
- Val Acc_paper：`0.3812 ± 0.0117`
- Test Acc_paper：`0.3810 ± 0.0154`
- Test BalAcc_maj：`0.3944 ± 0.0180`
...
- Val BalAcc_maj（附报）：`0.3907`

**Test 试次级**
- Acc_paper：`0.3721`
- BalAcc_maj：`0.3864`
- F1-macro（众数）：`0.3766`
- Rec idle/left/right：`0.2618` / `0.3345` / `0.5627`
- n_trials：`3300`

**Test 窗级（附报）**
- BalAcc：`0.3812` | F1m：`0.3720`

#### Fold 1

- stopped_epoch：`61` | best_epoch：`41`
- Val Acc_paper（早停）：`0.3967`
...
**Test 窗级（附报）**
- BalAcc：`0.4041` | F1m：`0.4032`

#### Fold 2

- stopped_epoch：`25` | best_epoch：`5`
- Val Acc_paper（早停）：`0.3663`
...
- BalAcc_maj：`0.3667`
- F1-macro（众数）：`0.3061`
- Rec idle/left/right：`0.7791` / `0.2436` / `0.0773`
- n_trials：`3300`
...
**Test 窗级（附报）**
- BalAcc：`0.4037` | F1m：`0.3944`

#### Fold 4

- stopped_epoch：`44` | best_epoch：`24`
- Val Acc_paper（早停）：`0.3733`
- Val BalAcc_maj（附报）：`0.3889`

**Test 试次级**
- Acc_paper：`0.3780`
- BalAcc_maj：`0.3917`
- F1-macro（众数）：`0.3829`
- Rec idle/left/right：`0.5370` / `0.3880` / `0.2500`
- n_trials：`3000`
