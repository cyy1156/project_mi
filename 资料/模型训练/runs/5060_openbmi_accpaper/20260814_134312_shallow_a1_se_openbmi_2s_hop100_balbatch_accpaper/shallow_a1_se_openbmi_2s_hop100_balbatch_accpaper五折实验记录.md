# 被试独立五折实验记录（20260814_134312 / shallow_a1_se_openbmi_2s_hop100_balbatch_accpaper）

- 开始：`2026-08-14T13:43:12`
...
- 权重：`D:\cyy\MI\code\train_lab\out\5060_shallow_se_eca_accpaper\shallow_a1_se_openbmi_2s_hop100_balbatch_accpaper\openbmi_2s_hop100\run_20260814_134312`
...
### Task
- Val Acc_paper：`0.6756 ± 0.0000`
- Test Acc_paper：`0.6897 ± 0.0000`
- Test BalAcc_maj：`0.6777 ± 0.0000`
- Test 窗级 BalAcc（附报）：`0.6512 ± 0.0000`
...
**Test 窗级（附报）**
- BalAcc：`0.6512` | F1：`0.7284` | Acc：`0.6612`

### Three
- Val Acc_paper：`0.5304 ± 0.0000`
- Test Acc_paper：`0.5188 ± 0.0000`
- Test BalAcc_maj：`0.5403 ± 0.0000`
- Test 窗级 BalAcc（附报）：`0.5170 ± 0.0000`
