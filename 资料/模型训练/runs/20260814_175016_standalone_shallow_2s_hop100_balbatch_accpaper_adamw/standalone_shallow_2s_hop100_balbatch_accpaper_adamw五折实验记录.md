# 5-fold experiment record (20260814_175016 / standalone_shallow_2s_hop100_balbatch_accpaper_adamw)

- start: `2026-08-14T17:50:16`
- device: `cpu`
...
- weights: `D:\360MoveData\Users\ckgxnn\Desktop\MI\self_model\out\optimizer_compare_smoke\adamw`
- shared hp: `{'n_folds': 5, 'val_ratio': 0.2, 'seed': 42, 'max_epochs': 2, 'patience': 2, 'batch_train': 32, 'batch_eval': 64, 'lr': 0.0001, 'weight_decay': 0.0001, 'drop_prob': 0.5, 'n_times_expected': 500, 'n_chans': 8, 'protocol': '2s-hop100ms-balbatch-accpaper-T-only', 'optimizer': 'adamw'}`
