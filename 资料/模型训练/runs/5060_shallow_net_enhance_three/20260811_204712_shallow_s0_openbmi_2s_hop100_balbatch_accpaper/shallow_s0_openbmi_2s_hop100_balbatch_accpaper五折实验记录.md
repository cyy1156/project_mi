# 被试独立五折实验记录（20260811_204712 / shallow_s0_openbmi_2s_hop100_balbatch_accpaper）

- 开始：`2026-08-11T20:47:12`
...
- model：`shallow_s0` | ShallowFBCSPNet S0 | tlen=25 nF=40/40 pool_stride=15
- Train：窗 CE + **batch balance**；Val/Test：整被试块 + trial 聚合 Acc_paper
- 权重：`D:\cyy\MI\code\train_lab\out\5060_shallow_net_enhance_three_accpaper\shallow_s0_openbmi_2s_hop100_balbatch_accpaper\openbmi_2s_hop100\run_20260811_204712`
...
**Test 窗级（附报）**
- BalAcc：`0.6506` | F1：`0.7258` | Acc：`0.6592`
...
**Test 窗级（附报）**
- BalAcc：`0.6270` | F1：`0.6887` | Acc：`0.6253`
...
**Test 窗级（附报）**
- BalAcc：`0.6438` | F1：`0.7209` | Acc：`0.6532`

### Three
- Val Acc_paper：`0.5226 ± 0.0318`
- Test Acc_paper：`0.5403 ± 0.0256`
- Test BalAcc_maj：`0.5581 ± 0.0257`
...
- BalAcc_maj：`0.5176`
- F1-macro（众数）：`0.5147`
- Rec idle/left/right：`0.5618` / `0.5836` / `0.4073`
- n_trials：`3300`

**Test 窗级（附报）**
- BalAcc：`0.4983` | F1m：`0.4960`

#### Fold 3

- stopped_epoch：`52` | best_epoch：`32`
- Val Acc_paper（早停）：`0.5644`
...
- BalAcc_maj：`0.5573`
- F1-macro（众数）：`0.5574`
- Rec idle/left/right：`0.5890` / `0.5510` / `0.5320`
- n_trials：`3000`
