# 被试独立五折实验记录（20260811_092430 / shallow_s0_net_enhance_three）

- 开始：`2026-08-11T09:24:30`
...
- 权重：`D:\挑战杯专属\project_mi\code\train_lab\out\5060_shallow_net_enhance_three_accpaper\shallow_s0_net_enhance_three\openbmi_2s_hop100\run_20260811_092430`
...
- Test 窗级 BalAcc（附报）：`0.6281 ± 0.0000`
...
**Test 窗级（附报）**
- BalAcc：`0.6281` | F1：`0.7054` | Acc：`0.6364`

### Three
- Val Acc_paper：`0.4819 ± 0.0000`
- Test Acc_paper：`0.5088 ± 0.0000`
- Test BalAcc_maj：`0.5252 ± 0.0000`
- Test 窗级 BalAcc（附报）：`0.5063 ± 0.0000`
...
- Val BalAcc_maj（附报）：`0.5007`

**Test 试次级**
- Acc_paper：`0.5088`
- BalAcc_maj：`0.5252`
- F1-macro（众数）：`0.5234`
- Rec idle/left/right：`0.5900` / `0.5409` / `0.4445`
- n_trials：`3300`

**Test 窗级（附报）**
- BalAcc：`0.5063` | F1m：`0.5054`
