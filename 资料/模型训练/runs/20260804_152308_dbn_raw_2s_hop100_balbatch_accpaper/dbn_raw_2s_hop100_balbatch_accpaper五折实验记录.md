# 被试独立五折实验记录（20260804_152308 / dbn_raw_2s_hop100_balbatch_accpaper）

- 开始：`2026-08-04T15:23:08`
- device：`cuda`
...
- model：`dbn_raw` | from baselines_2s_hop100/dbn_raw input_kind=raw
- Train：窗 CE + **batch balance**；Val/Test：整被试块 + trial 聚合 Acc_paper
- 权重：`D:\cyy\MI\code\train_lab\out\baseline_2s_hop100_accpaper\dbn_raw_2s_hop100_balbatch_accpaper\bci2a_2s_hop100\run_20260804_152308`
...
### Task
- Val Acc_paper：`0.3576 ± 0.0000`
- Test Acc_paper：`0.3258 ± 0.0000`
- Test BalAcc_maj：`0.5000 ± 0.0000`
- Test 窗级 BalAcc（附报）：`0.4985 ± 0.0000`
...
**Test 窗级（附报）**
- BalAcc：`0.4985` | F1：`0.0000` | Acc：`0.3185`
