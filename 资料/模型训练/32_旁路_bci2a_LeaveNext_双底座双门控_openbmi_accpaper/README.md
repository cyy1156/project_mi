...
**状态：** **已完成**（2026-09-01 重跑）· stamp=`20260901_124502` · **A01–A09 × 6 臂 = 54/54**  
（旧跑 stamp=`20260829_235900`，R5 九人均值差约 ±1pp，主结论不变）
...
## R5 九人 μ±σ（主结论速览 · 20260901_124502）

| 臂 | R5 μ±σ |
|----|--------|
| shallow × force | **0.671±0.067** |
| e1f_so × force | 0.452±0.047 |
| e1f_all4 × force | **0.663±0.067** |

- P1：all4 − so = **+0.211**（force · R5）→ **过 +2pp 门槛，倾向四员各自 FT**  
- P0：现行 so 融合读出在 Leave-Next 上弱于单头 shallow；all4 可回到与 shallow 同档  
- 门控 PASS（R1–R5）：S-st **29/45** · E-so-st **32/45** · E-a4-st **29/45**

详细汇报见登记表末节「实验结果汇报 · 2026-09-01 重跑」。
...
```text
python experiment_game/tools/run_exp32_leave_next_dual_model_gate.py --all --phase all --stamp 20260901_124502
```
