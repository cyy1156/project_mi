"""L-track task_runner: official Acc_paper loop + this package's SHARED/OUT_ROOT_TAG."""
...
# Seed our shared_hparams into cache BEFORE loading official task_runner
...
# Ensure local helpers resolve to our re-exports (which wrap official)
