"""5070 · 掩码未来表征预测 + 双专家门控 · OpenBMI Acc_paper（本机正式机位）.

本机 RTX 5070 Laptop / ~16GB RAM：小 batch、workers=0～2、关 pin（稳）。
历史 5060 结果只读；大 batch 对照请用 `5090_mask_future_dual_expert_accpaper/`。
...
TRAIN_DEVICE_LABEL = "NVIDIA RTX 5070 Laptop"
TRAIN_DEVICE_NOTE = "16GB · scheme17 mask-future · 5070 primary · low-mem fold0-first"
OUT_ROOT_TAG = "5070_mask_future_dual_expert_accpaper"
