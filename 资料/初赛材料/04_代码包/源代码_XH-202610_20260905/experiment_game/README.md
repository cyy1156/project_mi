...
若你是「AI 写过代码、想自己啃懂」：**[学习复现_从0到1/](./学习复现_从0到1/README.md)**（含学习进度表 `进度.md`）。

## 现行规范（2026-08-29）

| 文档 | 说明 |
|------|------|
| **[docs/统计口径方案A_20260831.md](./docs/统计口径方案A_20260831.md)** | **准确率/门控/早停口径权威（2026-08-31）** |
| **[docs/框架冻结确认_20260829.md](./docs/框架冻结确认_20260829.md)** | **冻结在线读出选型（试次级因果平滑多数票）** |
| **[docs/其他电脑移机攻略_20260829.md](./docs/其他电脑移机攻略_20260829.md)** | **跨机器部署逐步清单** |
| [docs/范式对齐_OpenBMI与fnz_v3_20260827.md](./docs/范式对齐_OpenBMI与fnz_v3_20260827.md) | OpenBMI-Align v1 时序 / Rest / 在线 |
| [docs/被试登录与按session微调方案_20260827.md](./docs/被试登录与按session微调方案_20260827.md) | 登录 / 目录 / 采后微调 |
| [`data/subjects/_analysis/在线采集准确率与微调后准确率核实_20260831.md`](./data/subjects/_analysis/在线采集准确率与微调后准确率核实_20260831.md) | 在线 vs FT 数值核实 |
| [`data/subjects/_analysis/前端准确率展示口径与统计改造说明_20260831.md`](./data/subjects/_analysis/前端准确率展示口径与统计改造说明_20260831.md) | 前端改造记录 |
| [docs/操作按键设计.md](./docs/操作按键设计.md) | 操作者/被试分键 |
| [docs/完整使用流程.md](./docs/完整使用流程.md) | 安装到开实验（部分章节仍偏旧 Phase，以冻结表为准） |

**现行默认**：CausalFuse-8 四成员集成 · Align 时序（专用 Rest4 → prep2 → **Cue 1s** → MI4）· 采后 Leave-Next · 块间默认 30s · 门控 FAIL 默认可强制晋升（F8）。
...
4. 权重默认 **CausalFuse-8 四成员集成**（可选手动单模型对照）  
