...
2026-08-29 自 experiment/channel_layout.py 平移至 core/（零语义改动）。
本模块为零依赖核心层：只允许标准库 / numpy，禁止 import 其它项目包。
"""
...
# 会话 meta / run_config 默认通道表（2026-08-29 定义上移至此，断 acquisition↔session 循环导入）
