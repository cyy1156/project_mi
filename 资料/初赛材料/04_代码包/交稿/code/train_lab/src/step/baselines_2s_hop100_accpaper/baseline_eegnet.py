"""EEGNet 2s/hop100 Acc_paper：原结构、无 RAP；Val Acc_paper + batch balance。"""
...
if __name__ == "__main__":
    run_baseline_main(
        ...
        input_kind="time",
        structure_note=f"EEGNet F1={EEGNET_F1}, D={EEGNET_D}, F2={EEGNET_F2}（默认池化）",
        extra_meta={"eegnet": {"F1": EEGNET_F1, "D": EEGNET_D, "F2": EEGNET_F2}, "accpaper": True},
    )
