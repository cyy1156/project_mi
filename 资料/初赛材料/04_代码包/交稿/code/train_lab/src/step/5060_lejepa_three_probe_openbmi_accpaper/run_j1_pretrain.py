"""J1 · LeJEPA 预训（L_pred + λ·SIGReg；无 EMA；按折排除 test 被试）。

用法:
  cd code/train_lab/src/step/5060_lejepa_three_probe_openbmi_accpaper
  python run_j1_pretrain.py --max-folds 1 --pretrain-epochs 5 --max-windows 8192
"""
...
def main():
    p = argparse.ArgumentParser(description="J1 LeJEPA pretrain (fold-safe)")
