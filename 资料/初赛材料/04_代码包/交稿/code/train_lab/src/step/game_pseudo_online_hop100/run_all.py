"""串跑 Top5 伪在线模型（形态对齐 baselines_2s_hop100_accpaper/run_all.py）。

用法：
  python run_all.py
  python run_all.py --models eegnet,shallow --continue-on-error
  python run_all.py --smoke
  python baseline_eegnet.py --sessions sub02_ses01_20260723_180607 --skip-three
"""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="串跑 game_pseudo_online_hop100")
    p.add_argument(
        "--models",
