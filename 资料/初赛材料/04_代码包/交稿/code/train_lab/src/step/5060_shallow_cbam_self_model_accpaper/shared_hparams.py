"""Scheme 15 · OpenBMI Acc_paper · self_model Shallow + CBAM."""
from __future__ import annotations

from dataclasses import asdict, dataclass


OUT_ROOT_TAG = "5060_shallow_cbam_self_model_accpaper"
...
class SharedTrainHP:
    ...
    protocol: str = (
        "2s-hop100ms-balbatch-accpaper-openbmi-shallow-cbam-self_model "
