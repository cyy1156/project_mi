"""Stieger 1 s / 40 ms 协议（与旧「反馈末 2s/4s」流水线分离）。

Rest：Cue(=fb0) 前 4 s → slide_1s；不再使用 down 作 Rest。
Task：左/右反馈全程 [fb0, fb1) → slide_1s；丢 up/down、artifact、反馈 < 1 s。
"""
