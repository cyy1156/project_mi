...
> 更新：2026-08-21 · **部署口径修订：2026-08-29**  
> 定位：在 `experiment_game` 已采会话上做伪在线回放评测。  
> **现行在线部署（现场）**：见 `experiment_game/docs/框架冻结确认_20260829.md` —— **3s hop100 · E1f 四成员**（非下表 2s）。  
> 下表「2s 部署」为 **历史伪在线证据**，勿当作 2026-08 操作台默认权重。  
> **按模型查阅**（推荐）：[`按模型/`](./按模型/)  
> 代码：`code/train_lab/src/step/game_pseudo_online_hop100/`（2s 主线；3s 见臂 07）

## 历史部署口径（2s · 已接受 · 2026-08-09 · **已过时**）
