"""被试 OpenBMI-Align 微调（总册 W4：自 tools 下沉至 pipeline）。

CLI 入口仍为::

  python -m experiment_game.tools.ft_subject_from_v3 ...
  # 或
  python -m experiment_game.pipeline.finetune ...
"""
...
from experiment_game.pipeline.openbmi_replay_pool import (  # noqa: E402
