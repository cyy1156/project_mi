...
>   readout.py      ← causal_smooth_preds, majority_vote
>   scoring.py      ← MiTrialTracker
> self_learing/tests/
>   test_f5_scoring.py
> ```
...
## `readout.py` → `self_learing/src/self_learing/readout.py`
...
## `scoring.py` → `self_learing/src/self_learing/scoring.py`
...
## `tests/test_f5_scoring.py` → `self_learing/tests/test_f5_scoring.py`
