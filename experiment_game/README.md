...
| **[docs/框架冻结确认_20260829.md](./docs/框架冻结确认_20260829.md)** | **冻结选择题结论（F5 在线读出）** |
...
**现行默认**：E1f 四成员 · Align 时序（专用 Rest4 → prep2 → **Cue 1s** → MI4）· 采后 Leave-Next · 块间默认 30s · 门控 FAIL 默认可强制晋升（F8）。
